...
class ProfilePostsApi:
    ...
    def list(self, user_id: str | int, *, params: ProfilePostsListParams | None = None) -> ProfilePostsListResponse:
    ...
    def edit(self, profile_post_id: int, *, body: ProfilePostsEditBody | None = None) -> ProfilePostsEditResponse:
        return self._http.request(RequestOptions(
            method="PUT",
            path=f"/profile-posts/{profile_post_id}",
            body=body,
    ...
    def delete(self, profile_post_id: int, *, params: ProfilePostsDeleteParams | None = None) -> ProfilePostsDeleteResponse:
        return self._http.request(RequestOptions(
            method="DELETE",
            path=f"/profile-posts/{profile_post_id}",
            query=params,
    ...
    def report(self, profile_post_id: int, *, body: ProfilePostsReportBody) -> ProfilePostsReportResponse:
        return self._http.request(RequestOptions(
            method="POST",
            path=f"/profile-posts/{profile_post_id}/report",
            body=body,
    ...
    def comments_list(self, *, params: ProfilePostsCommentsListParams) -> ProfilePostsCommentsListResponse:
        return self._http.request(RequestOptions(
            method="GET",
    ...
    def comments_create(self, *, body: ProfilePostsCommentsCreateBody) -> ProfilePostsCommentsCreateResponse:
        return self._http.request(RequestOptions(
            method="POST",
            path="/profile-posts/comments",
            body=body,
    ...
    def comments_edit(self, *, body: ProfilePostsCommentsEditBody) -> ProfilePostsCommentsEditResponse:
        return self._http.request(RequestOptions(
            method="PUT",
            path="/profile-posts/comments",
            body=body,
    ...
    def comments_delete(self, *, body: ProfilePostsCommentsDeleteBody) -> ProfilePostsCommentsDeleteResponse:
        return self._http.request(RequestOptions(
            method="DELETE",
            path="/profile-posts/comments",
            body=body,
    ...
    def comments_get(self, profile_post_id: int, comment_id: int) -> ProfilePostsCommentsGetResponse:
        return self._http.request(RequestOptions(
            method="GET",
            path=f"/profile-posts/{profile_post_id}/comments/{comment_id}",
        ))

    def comments_report(self, comment_id: int, *, body: ProfilePostsCommentsReportBody) -> ProfilePostsCommentsReportResponse:
        return self._http.request(RequestOptions(
            method="POST",
...
class AsyncProfilePostsApi:
    ...
    async def list(self, user_id: str | int, *, params: ProfilePostsListParams | None = None) -> ProfilePostsListResponse:
    ...
    async def edit(self, profile_post_id: int, *, body: ProfilePostsEditBody | None = None) -> ProfilePostsEditResponse:
        return await self._http.request(RequestOptions(
            method="PUT",
            path=f"/profile-posts/{profile_post_id}",
            body=body,
    ...
    async def delete(self, profile_post_id: int, *, params: ProfilePostsDeleteParams | None = None) -> ProfilePostsDeleteResponse:
        return await self._http.request(RequestOptions(
            method="DELETE",
            path=f"/profile-posts/{profile_post_id}",
            query=params,
    ...
    async def report(self, profile_post_id: int, *, body: ProfilePostsReportBody) -> ProfilePostsReportResponse:
        return await self._http.request(RequestOptions(
            method="POST",
            path=f"/profile-posts/{profile_post_id}/report",
            body=body,
    ...
    async def comments_list(self, *, params: ProfilePostsCommentsListParams) -> ProfilePostsCommentsListResponse:
        return await self._http.request(RequestOptions(
            method="GET",
            path="/profile-posts/comments",
            query=params,
    ...
    async def comments_create(self, *, body: ProfilePostsCommentsCreateBody) -> ProfilePostsCommentsCreateResponse:
        return await self._http.request(RequestOptions(
            method="POST",
            path="/profile-posts/comments",
            body=body,
    ...
    async def comments_edit(self, *, body: ProfilePostsCommentsEditBody) -> ProfilePostsCommentsEditResponse:
        return await self._http.request(RequestOptions(
            method="PUT",
            path="/profile-posts/comments",
            body=body,
    ...
    async def comments_delete(self, *, body: ProfilePostsCommentsDeleteBody) -> ProfilePostsCommentsDeleteResponse:
        return await self._http.request(RequestOptions(
            method="DELETE",
            path="/profile-posts/comments",
            body=body,
    ...
    async def comments_get(self, profile_post_id: int, comment_id: int) -> ProfilePostsCommentsGetResponse:
        return await self._http.request(RequestOptions(
            method="GET",
            path=f"/profile-posts/{profile_post_id}/comments/{comment_id}",
        ))

    async def comments_report(self, comment_id: int, *, body: ProfilePostsCommentsReportBody) -> ProfilePostsCommentsReportResponse:
        return await self._http.request(RequestOptions(
            method="POST",
            path=f"/profile-posts/comments/{comment_id}/report",
            body=body,
