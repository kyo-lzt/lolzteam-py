...
class SearchApi:
    ...
    def profileposts(self, *, body: SearchProfilepostsBody | None = None) -> SearchProfilepostsResponse:
        return self._http.request(RequestOptions(
            method="POST",
    ...
    def results(self, search_id: str | int, *, body: SearchResultsBody | None = None) -> SearchResultsResponse:
        return self._http.request(RequestOptions(
            method="GET",
...
class AsyncSearchApi:
    ...
    async def profileposts(self, *, body: SearchProfilepostsBody | None = None) -> SearchProfilepostsResponse:
        return await self._http.request(RequestOptions(
            method="POST",
            path="/search/profile-posts",
            body=body,
    ...
    async def results(self, search_id: str | int, *, body: SearchResultsBody | None = None) -> SearchResultsResponse:
        return await self._http.request(RequestOptions(
            method="GET",
            path=f"/search/{search_id}/results",
            body=body,
