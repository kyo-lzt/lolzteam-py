...
class ThreadsApi:
    ...
    def delete(self, thread_id: int, *, body: ThreadsDeleteBody | None = None) -> ThreadsDeleteResponse:
        return self._http.request(RequestOptions(
            method="DELETE",
            path=f"/threads/{thread_id}",
            body=body,
    ...
    def follow(self, thread_id: int, *, body: ThreadsFollowBody | None = None) -> ThreadsFollowResponse:
        return self._http.request(RequestOptions(
            method="POST",
            path=f"/threads/{thread_id}/followers",
            body=body,
    ...
    def poll_vote(self, thread_id: int, *, body: ThreadsPollVoteBody | None = None) -> ThreadsPollVoteResponse:
        return self._http.request(RequestOptions(
            method="POST",
...
class AsyncThreadsApi:
    ...
    async def createcontest(self, *, body: ThreadsCreatecontestBody) -> ThreadsCreatecontestResponse:
        return await self._http.request(RequestOptions(
            method="POST",
            path="/contests",
            body=body,
    ...
    async def get(self, thread_id: int, *, params: ThreadsGetParams | None = None) -> ThreadsGetResponse:
        return await self._http.request(RequestOptions(
            method="GET",
            path=f"/threads/{thread_id}",
            query=params,
    ...
    async def edit(self, thread_id: int, *, body: ThreadsEditBody | None = None) -> ThreadsEditResponse:
        return await self._http.request(RequestOptions(
            method="PUT",
            path=f"/threads/{thread_id}",
            body=body,
    ...
    async def delete(self, thread_id: int, *, body: ThreadsDeleteBody | None = None) -> ThreadsDeleteResponse:
        return await self._http.request(RequestOptions(
            method="DELETE",
            path=f"/threads/{thread_id}",
            body=body,
    ...
    async def follow(self, thread_id: int, *, body: ThreadsFollowBody | None = None) -> ThreadsFollowResponse:
        return await self._http.request(RequestOptions(
            method="POST",
            path=f"/threads/{thread_id}/followers",
            body=body,
    ...
    async def followed(self, *, params: ThreadsFollowedParams | None = None) -> ThreadsFollowedResponse:
        return await self._http.request(RequestOptions(
            method="GET",
            path="/threads/followed",
            query=params,
    ...
    async def poll_vote(self, thread_id: int, *, body: ThreadsPollVoteBody | None = None) -> ThreadsPollVoteResponse:
        return await self._http.request(RequestOptions(
            method="POST",
            path=f"/threads/{thread_id}/poll/votes",
            body=body,
