...
class UsersApi:
    ...
    def claims(self, user_id: str | int, *, params: UsersClaimsParams | None = None) -> UsersClaimsResponse:
        return self._http.request(RequestOptions(
            method="GET",
    ...
    def avatar_upload(self, user_id: str | int, *, body: UsersAvatarUploadBody) -> UsersAvatarUploadResponse:
        return self._http.request(RequestOptions(
            method="POST",
    ...
    def avatar_crop(self, user_id: str | int, *, body: UsersAvatarCropBody | None = None) -> UsersAvatarCropResponse:
        return self._http.request(RequestOptions(
            method="POST",
    ...
    def background_upload(self, user_id: str | int, *, body: UsersBackgroundUploadBody) -> UsersBackgroundUploadResponse:
        return self._http.request(RequestOptions(
            method="POST",
    ...
    def background_crop(self, user_id: str | int, *, body: UsersBackgroundCropBody) -> UsersBackgroundCropResponse:
        return self._http.request(RequestOptions(
            method="POST",
    ...
    def followers(self, user_id: str | int, *, params: UsersFollowersParams | None = None) -> UsersFollowersResponse:
        return self._http.request(RequestOptions(
            method="GET",
    ...
    def followings(self, user_id: str | int, *, params: UsersFollowingsParams | None = None) -> UsersFollowingsResponse:
        return self._http.request(RequestOptions(
            method="GET",
    ...
    def likes(self, user_id: str | int, *, params: UsersLikesParams | None = None) -> UsersLikesResponse:
        return self._http.request(RequestOptions(
            method="GET",
    ...
    def ignoreedit(self, user_id: str | int, *, params: UsersIgnoreeditParams | None = None) -> UsersIgnoreeditResponse:
        return self._http.request(RequestOptions(
            method="PUT",
            path=f"/users/{user_id}/ignore",
            query=params,
    ...
    def contents(self, user_id: str | int, *, params: UsersContentsParams | None = None) -> UsersContentsResponse:
        return self._http.request(RequestOptions(
            method="GET",
...
class AsyncUsersApi:
    ...
    async def get(self, user_id: str | int, *, params: UsersGetParams | None = None) -> UsersGetResponse:
        return await self._http.request(RequestOptions(
            method="GET",
            path=f"/users/{user_id}",
            query=params,
    ...
    async def edit(self, user_id: str | int, *, body: UsersEditBody | None = None) -> UsersEditResponse:
        return await self._http.request(RequestOptions(
            method="PUT",
            path=f"/users/{user_id}",
            body=body,
    ...
    async def claims(self, user_id: str | int, *, params: UsersClaimsParams | None = None) -> UsersClaimsResponse:
        return await self._http.request(RequestOptions(
            method="GET",
            path=f"/users/{user_id}/claims",
            query=params,
    ...
    async def avatar_upload(self, user_id: str | int, *, body: UsersAvatarUploadBody) -> UsersAvatarUploadResponse:
        return await self._http.request(RequestOptions(
            method="POST",
            path=f"/users/{user_id}/avatar",
            body=body,
    ...
    async def avatar_crop(self, user_id: str | int, *, body: UsersAvatarCropBody | None = None) -> UsersAvatarCropResponse:
        return await self._http.request(RequestOptions(
            method="POST",
            path=f"/users/{user_id}/avatar/crop",
            body=body,
    ...
    async def background_upload(self, user_id: str | int, *, body: UsersBackgroundUploadBody) -> UsersBackgroundUploadResponse:
        return await self._http.request(RequestOptions(
            method="POST",
            path=f"/users/{user_id}/background",
            body=body,
    ...
    async def background_crop(self, user_id: str | int, *, body: UsersBackgroundCropBody) -> UsersBackgroundCropResponse:
        return await self._http.request(RequestOptions(
            method="POST",
            path=f"/users/{user_id}/background/crop",
            body=body,
    ...
    async def followers(self, user_id: str | int, *, params: UsersFollowersParams | None = None) -> UsersFollowersResponse:
        return await self._http.request(RequestOptions(
            method="GET",
            path=f"/users/{user_id}/followers",
            query=params,
    ...
    async def followings(self, user_id: str | int, *, params: UsersFollowingsParams | None = None) -> UsersFollowingsResponse:
        return await self._http.request(RequestOptions(
            method="GET",
            path=f"/users/{user_id}/followings",
            query=params,
    ...
    async def likes(self, user_id: str | int, *, params: UsersLikesParams | None = None) -> UsersLikesResponse:
        return await self._http.request(RequestOptions(
            method="GET",
            path=f"/users/{user_id}/likes",
            query=params,
    ...
    async def ignoreedit(self, user_id: str | int, *, params: UsersIgnoreeditParams | None = None) -> UsersIgnoreeditResponse:
        return await self._http.request(RequestOptions(
            method="PUT",
            path=f"/users/{user_id}/ignore",
            query=params,
    ...
    async def contents(self, user_id: str | int, *, params: UsersContentsParams | None = None) -> UsersContentsResponse:
        return await self._http.request(RequestOptions(
            method="GET",
            path=f"/users/{user_id}/timeline",
            query=params,
