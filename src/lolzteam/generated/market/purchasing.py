...
class PurchasingApi:
    ...
    def fastbuy(self, item_id: int, *, body: PurchasingFastbuyBody | None = None) -> PurchasingFastbuyResponse:
    ...
    def confirm(self, item_id: int, *, body: PurchasingConfirmBody | None = None) -> PurchasingConfirmResponse:
        return self._http.request(RequestOptions(
            method="POST",
    ...
    def discountrequest(self, item_id: int, *, body: PurchasingDiscountrequestBody) -> PurchasingDiscountrequestResponse:
        return self._http.request(RequestOptions(
            method="POST",
...
class AsyncPurchasingApi:
    ...
    async def fastbuy(self, item_id: int, *, body: PurchasingFastbuyBody | None = None) -> PurchasingFastbuyResponse:
    ...
    async def confirm(self, item_id: int, *, body: PurchasingConfirmBody | None = None) -> PurchasingConfirmResponse:
        return await self._http.request(RequestOptions(
            method="POST",
            path=f"/{item_id}/confirm-buy",
            body=body,
    ...
    async def discountrequest(self, item_id: int, *, body: PurchasingDiscountrequestBody) -> PurchasingDiscountrequestResponse:
        return await self._http.request(RequestOptions(
            method="POST",
            path=f"/{item_id}/discount",
            body=body,
